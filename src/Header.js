  ...
  return (
    <div className="header d-flex align-items-center justify-content-space-between">
        ...
        <div className="logo">
          <a href="#">
            <svg
              ...
              focusable="false"
              class="style-scope yt-icon pointer"
              style={{ width: "120px", height: "30px", paddingRight: "40px" }}
            >
              <g
                viewBox="0 0 90 20"
                preserveAspectRatio="xMidYMid meet"
      ...
      <div className="header-middle-items d-flex align-items-center">
        <div className="input-box relative">
          ...
          <div className="search-box absolute d-flex align-items-center justify-content-center">
            <svg
              ...
              preserveAspectRatio="xMidYMid meet"
              focusable="false"
              class="style-scope yt-icon pointer search-symbol"
        ...
        <div className="voice-search d-flex align-items-center justify-content-center">
          <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
            focusable="false"
      ...
      <div className="header-rightbar d-flex align-items-center ">
        <div className="create-options d-flex align-items-center">
          <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
            focusable="false"
        ...
        <div className="youtube-apps d-flex align-items-center">
          <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
            focusable="false"
            class="style-scope yt-icon pointer mxy-15"
            style={{ width: "40px", height: "20px", paddingRight:"10px"}}
          >
            <g class="style-scope yt-icon">
              <path
        ...
        <div className="Profile-menu">
          <div className="profile-img d-flex align-items-center">
            <img
              src="https://yt3.ggpht.com/yti/AJo0G0lMQTSNCgK62t2cnJWf6KHXQV7wQaOFkcqgR5xM=s88-c-k-c0x00ffffff-no-rj-mo"
              alt=""
              className="dp mxy-15"
            />
          </div>
